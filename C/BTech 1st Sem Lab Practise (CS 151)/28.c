...
//C program to compare the contents of two files and determine whether they are the same or not.
//Author: Subhan Raj
...
int cF(FILE *fPtr1, FILE *fPtr2, int *line, int *col);

/* Question29. WAP to check whether a given word exists in a file or not. If yes then find the number of
times it occurs*/
/* Objective :To create a c program to check whether a given word exists in a file or not. If yes then find the number of
times it occurs*/
